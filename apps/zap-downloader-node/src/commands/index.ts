...
export { command as dependenciesCommand, describe as dependenciesDescribe, builder as dependenciesBuilder, handler as dependenciesHandler } from './dependencies';
